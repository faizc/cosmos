    ...
    public static String MASTER_KEY =
            System.getProperty("ACCOUNT_KEY",
                    StringUtils.defaultString(StringUtils.trimToNull(
                            ...
                            "lxiiqa7FrR5miDkjbZ1uoXUZpSgK6IPBU6lXjiedTlR28qC54tG36WlUnC6AgfvhTzpyS1VYJXfUlUvqwq4rNg=="));

    public static boolean AADBASEDAUTH = Boolean.parseBoolean(
            System.getProperty("ACCOUNT_KEY",
                    StringUtils.defaultString(StringUtils.trimToNull(
                                    System.getenv().get("AADBASEDAUTH")),
                            "false")));
