...
public class EmulatorSample {
    //
    private static final Logger LOGGER = LoggerFactory.getLogger(EmulatorSample.class);
    //
    ...
    public static void main(String[] args) {
        EmulatorSample p = new EmulatorSample();
        try {
            //
    ...
    private void batchrecord() throws Exception {
        ...
        executor.submit(new EmulatorSample.CosmosRunnable(Long.toString(100), container));
        //
        try {
            latch.await();
